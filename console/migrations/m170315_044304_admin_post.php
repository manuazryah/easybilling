...
class m170315_044304_admin_post extends Migration {
        ...
        public function up() {
                ...
                $this->createTable('{{%admin_posts}}', [
                    ...
                    'admin' => $this->Integer()->notNull()->defaultValue(0),
                    'masters' => $this->Integer()->notNull()->defaultValue(0),
        ...
        public function down() {
                echo "m170315_044304_admin_post cannot be reverted.\n";
