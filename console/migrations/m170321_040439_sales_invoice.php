...
class m170321_040439_sales_invoice extends Migration {
        ...
        public function up() {
                ...
                $this->createTable('{{%sales_invoice_master}}', [
                    'id' => $this->primaryKey(),
                ...
                $this->alterColumn('{{%sales_invoice_master}}', 'id', $this->integer() . ' NOT NULL AUTO_INCREMENT');

                $this->createTable('{{%sales_invoice_details}}', [
                    'id' => $this->primaryKey(),
                ...
                $this->alterColumn('{{%sales_invoice_details}}', 'id', $this->integer() . ' NOT NULL AUTO_INCREMENT');

                $this->createIndex('sales-invoice-master', 'sales_invoice_details', 'sales_invoice_master_id', $unique = false);
                $this->addForeignKey("sales-invoice-master", "sales_invoice_details", "sales_invoice_master_id", "sales_invoice_master", "id", "RESTRICT", "RESTRICT");
        }

        public function down() {
                echo "m170321_040439_sales_invoice cannot be reverted.\n";
