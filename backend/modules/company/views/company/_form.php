...
//                    'value' => '23-Feb-1982 10:10',
        ...
        <div class='col-md-4 col-sm-6 col-xs-12'>
                <?= $form->field($model, 'state')->dropDownList($state, ['prompt' => '-Choose State-', 'class' => 'form-control state-change']) ?>

        </div>
        <div class='col-md-4 col-sm-6 col-xs-12'>
                <?= $form->field($model, 'city')->dropDownList($city, ['prompt' => '-Choose City-', 'class' => 'form-control city-change']) ?>
