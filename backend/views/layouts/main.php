                ...
                <div class="sidebar-menu-inner">
                    ...
                    <ul id="main-menu" class="main-menu">
                        ...
                        <li class="">
                            ...
                            <ul>
                                <?php
                                $company = common\models\Company::find()->where(['user_id' => Yii::$app->user->identity->id])->one();
                                ?>
                                <li>
                                    <?= Html::a('Company Details', ['/company/company/view', 'id' => $company->id], ['class' => 'title']) ?>
                                </li>
                                <li>
                        ...
                        <li class="">
                            ...
                            <ul>
                                ...
                                <!--                                <li>
                                <?php // Html::a('State', ['/masters/state/index'], ['class' => 'title']) ?>
                                                                </li>
                                                                <li>
                                <?php // Html::a('City', ['/masters/city/index'], ['class' => 'title']) ?>
                                                                </li>-->
                            </ul>
                        </li>
